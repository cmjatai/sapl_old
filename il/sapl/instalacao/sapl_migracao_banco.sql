...
CREATE TABLE IF NOT EXISTS `props_painel` (
  ...
  `txt_apartante_exp_tempo` VARCHAR(45) NULL ,
  `txt_apartante_fonte` VARCHAR(5) NULL,
  `txt_questao_ordem_cor` VARCHAR(45) NULL ,
  `txt_questao_ordem_exp_tempo` VARCHAR(45) NULL ,
  `txt_questao_ordem_fonte` VARCHAR(5) NULL,
  `txt_orador_cor` VARCHAR(45) NULL ,
  `txt_orador_exp_tempo` VARCHAR(45) NULL ,
  `txt_orador_fonte` VARCHAR(5) NULL ,
  `txt_apartante_ord_tempo` VARCHAR(45) NULL ,
  `txt_questao_ordem_ord_tempo` VARCHAR(45) NULL ,
  `txt_orador_ord_tempo` VARCHAR(45) NULL ,
...
CREATE TABLE `spdo_users` (
  `cod_spdo_users` INT NOT NULL AUTO_INCREMENT,
  `txt_login_sapl` VARCHAR(45) NOT NULL,
  `txt_login_spdo` VARCHAR(45) NOT NULL,
  `txt_senha_spdo` VARCHAR(45) NULL,
  `ind_excluido` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`cod_spdo_users`)
  ) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

ALTER TABLE `unidade_tramitacao` ADD COLUMN `cod_unid_spdo` INT(11) NULL AFTER `cod_parlamentar`,
 ADD COLUMN `txt_unid_spdo` VARCHAR(45) NULL AFTER `cod_unid_spdo`;

ALTER TABLE `protocolo`
ADD COLUMN `num_protocolo_spdo` VARCHAR(18) NULL DEFAULT NULL AFTER `timestamp_anulacao`,
ADD UNIQUE INDEX `num_protocolo_spdo_UNIQUE` (`num_protocolo_spdo` ASC);

ALTER TABLE `materia_legislativa`
ADD COLUMN `num_protocolo_spdo` VARCHAR(18) NULL DEFAULT NULL AFTER `num_protocolo`;

CREATE TABLE `apenso` (
  `cod_materia_principal` INT NOT NULL,
  `cod_materia_apensada` INT NOT NULL,
  `dat_apensacao` DATE NOT NULL,
  `dat_desapensacao` DATE NULL,
  `ind_excluido` TINYINT(4) NOT NULL,
  PRIMARY KEY (`cod_materia_principal`, `cod_materia_apensada`)
  ) ENGINE=MyISAM  DEFAULT CHARSET=utf8;

-- SQL para quem fez a instalacao do SAPL3 e necessita atualizar
-- Esta comentado para que nao seja executado
--ALTER TABLE `props_painel`
--    CHANGE COLUMN `txt_apartante_tempo` `txt_apartante_exp_tempo` VARCHAR(45) NULL DEFAULT NULL ,
--    CHANGE COLUMN `txt_questao_ordem_tempo` `txt_questao_ordem_exp_tempo` VARCHAR(45) NULL DEFAULT NULL ,
--    CHANGE COLUMN `txt_orador_tempo` `txt_orador_exp_tempo` VARCHAR(45) NULL DEFAULT NULL ,
--    ADD COLUMN `txt_apartante_ord_tempo` VARCHAR(45) NULL ,
--    ADD COLUMN `txt_questao_ordem_ord_tempo` VARCHAR(45) NULL ,
--    ADD COLUMN `txt_orador_ord_tempo` VARCHAR(45) NULL
