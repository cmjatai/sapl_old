...
def paraStyle():
    ...
    tmp_data+='\t\t</initialize>\n'
    tmp_data+='\t\t<paraStyle name="P1" fontName="Helvetica-Bold" fontSize="5.0" leading="3" alignment="CENTER"/>\n'
    tmp_data+='\t\t<paraStyle name="P2" fontName="Helvetica" fontSize="9.0" leading="12" alignment="CENTER"/>\n'
    tmp_data+='\t\t<paraStyle name="P3" fontName="Helvetica" fontSize="12.0" leading="11" alignment="CENTER"/>\n'
    tmp_data+='\t</stylesheet>\n'
