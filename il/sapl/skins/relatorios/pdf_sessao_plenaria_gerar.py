##parameters=rodape_dic, imagem, inf_basicas_dic, lst_mesa, lst_presenca_sessao, lst_expedientes, lst_expediente_materia, lst_oradores_expediente, lst_presenca_ordem_dia, lst_votacao, lst_oradores, sessao=''
...
def expediente_materia(lst_expediente_materia):
    ...
    for expediente_materia in lst_expediente_materia:
        ...
        autoria=[]
        autoria=expediente_materia["autoria_exp_mat"]
        j=0
