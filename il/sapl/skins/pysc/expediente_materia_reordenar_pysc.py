...
expediente_materia = context.zsql.expediente_materia_reordena_obter_zsql(
...
for materia in expediente_materia:
    ...
    context.zsql.atualiza_expediente_materia_reordena_zsql(
        cod_sessao_plen=cods, cod_materia=codm, num_ordem=nd)
return 1
